...
.. note::
    If you need more information about what is a fiscal position and how it works in SwissCRM, please refer to `How to adapt taxes to my customer status or localization <https://www.swissconsultings.ch/documentation/user/online/accounting/others/taxes/application.html>`_.
...
.. note::
    How a bank operation model works exactly in SwissCRM? See `Configure model of entries <https://www.swissconsultings.ch/documentation/user/online/accounting/bank/reconciliation/configure.html>`_.
...
Once it's done, you can start the creation of your report statements. The documentation is available in the following `slides <https://swissconsultings.ch>`_.

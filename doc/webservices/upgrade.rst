...
.. py:function:: https://upgrade.swisshq.com/database/v1/create
...
.. switcher::
    ...
    .. code-block:: python
        ...
        CREATE_URL = "https://upgrade.swisshq.com/database/v1/create"
...
.. py:function:: https://upgrade.swisshq.com/database/v1/upload
...
.. switcher::
    ...
    .. code-block:: python
        ...
        UPLOAD_URL = "https://upgrade.swisshq.com/database/v1/upload"
...
.. py:function:: https://upgrade.swisshq.com/database/v1/request_sftp_access
...
.. switcher::
    ...
    .. code-block:: python
        ...
        UPLOAD_URL = "https://upgrade.swisshq.com/database/v1/request_sftp_access"
    ...
    .. code-block:: bash
        ...
        REQUEST_SFTP_ACCESS_URL="https://upgrade.swisshq.com/database/v1/request_sftp_access"
...
::
    ...
    $ sftp -P 2200 user_10534@upgrade.swisshq.com
    Connected to upgrade.swisshq.com.
...
::
  ...
  echo "put /path/to/openchs.70.cdump openchs.70.cdump" | sftp -b - -P 2200 user_10534@upgrade.swisshq.com
...
.. py:function:: https://upgrade.swisshq.com/database/v1/process
...
.. switcher::
    ...
    .. code-block:: python
        ...
        PROCESS_URL = "https://upgrade.swisshq.com/database/v1/process"
...
.. py:function:: https://upgrade.swisshq.com/database/v1/skip_test
...
.. switcher::
    ...
    .. code-block:: python
        ...
        PROCESS_URL = "https://upgrade.swisshq.com/database/v1/skip_test"
...
.. py:function:: https://upgrade.swisshq.com/database/v1/status
...
.. switcher::
    ...
    .. code-block:: python
        ...
        PROCESS_URL = "https:/upgrade.swisshq.com/database/v1/status"
    ...
    .. code-block:: bash
        ...
        STATUS_URL="https://upgrade.swisshq.com/database/v1/status"
        KEY="Aw7pItGVKFuZ_FOR3U8VFQ=="
        REQUEST_ID="10534"
        URL_PARAMS="key=${KEY}&request=${REQUEST_ID}"
    ...
    .. code-block:: json

        {
          ...
          "request": {
            ...
            "issue_stage": "new",
            "issue": 648398,
            "status_url": "https://upgrade.swisshq.com/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/status",
            "notes_url": "https://upgrade.swisshq.com/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/upgraded/notes",
            "original_sql_url": "https://upgrade.swisshq.com/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/original/sql",
            "original_dump_url": "https://upgrade.swisshq.com/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/original/archive",
            "upgraded_sql_url": "https://upgrade.swisshq.com/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/upgraded/sql",
            "upgraded_dump_url": "https://upgrade.swisshq.com/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/upgraded/archive",
            "modules_url": "https://upgrade.swisshq.com/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/modules/archive",
            "filesize": "912.99 Kb",
            "database_uuid": null,

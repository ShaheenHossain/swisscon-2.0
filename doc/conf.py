...
# put current swiss's source on PYTHONPATH for autodoc
...
project = u'swiss'
copyright = u'SwissCRM  Inc., Odoo S.A.'
...
html_theme = 'swiss_ext'

swiss_cover_default = 'banners/installing_swiss.jpg'
...
gitlab_user = 'swiss-hq'
gitlab_project = 'swiss'

...
===================
Security in SwissCRM
===================

Aside from manually managing access using custom code, SwissCRM provides two main
...
An ORM :class:`~swiss.fields.Field` can have a ``groups`` attribute
...
* restricted fields are removed from :meth:`~swiss.models.Model.fields_get`
  responses
...
<webservices/swiss/calling_methods>` with the chosen parameters. The methods
...
be avoided at all cost. A safer, sandboxed, method :class:`~swiss.tools.safe_eval`

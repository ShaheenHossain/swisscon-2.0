...
:class:`~swiss.models.Model`, but can't use the same mechanism as the
...
Controllers are created by :ref:`inheriting <python:tut-inheritance>` from :class:`~swiss.http.Controller`.
Routes are defined through methods decorated with :func:`~swiss.http.route`::
...
* decorating with :func:`~swiss.http.route` is necessary to keep the method
...
The request object is automatically set on :data:`swiss.http.request` at
the start of the request

.. autoclass:: swiss.http.WebRequest
    :members:
    :member-order: bysource
.. autoclass:: swiss.http.HttpRequest
    :members:
.. autoclass:: swiss.http.JsonRequest
    :members:

Response
--------

.. autoclass:: swiss.http.Response
    :members:
    :member-order: bysource

...
Step 2: Configure the swiss instance with your zone
-----------------------------------------------------

In the SwissCRM back end, go to the :guilabel:`Website Settings`: menu, then
...
.. image:: cdn/swiss_cdn_base_url.png
   :class: img-responsive
...
.. image:: cdn/swiss_check_your_html.png
   :class: img-responsive
...
resulting problem on a default SwissCRM website will be the lack of font-awesome
...
.. image:: cdn/swiss_font_file_not_loaded.png
   :class: img-responsive

A security error message will also appear in the browser's console:

.. image:: cdn/swiss_security_message.png
   :class: img-responsive

# -*- coding: utf-8 -*-
"""
Test various crap patterns found in SwissCRM code to ensure they don't blow up
the parser thingie
"""
...
def test_prototype():
    ...
    swiss.define('mod2', function (require) {

...
def test_single():
     ...
     */
    swiss.define('supermodule', function (req) {
        var other = req('other');
    });
    """)
...
def test_multiple():
    ...
    swiss.define('module1', function (req) {
        return 1;
    });
    swiss.define('module2', function (req) {
        return req('dep2');
    });
    swiss.define('module3', function (req) {
        var r = req('dep3');
        return r;
    });
    """)
...
def test_func():
    [mod] = parse("""
    swiss.define('module', function (d) {
        /**
...
def test_export_instance():
    [mod] = parse("""
    swiss.define('module', function (require) {
...
def test_bounce():
    [m2, m1] = parse("""
    swiss.define('m2', function (require) {
        var Item = require('m1');
        return {
            Item: Item
        };
    });
    swiss.define('m1', function (require) {
        var Class = require('Class');
...
def test_reassign():
    [m] = parse("""
    swiss.define('m', function (require) {
        var Class = require('Class');
        /** local class */

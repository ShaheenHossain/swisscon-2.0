swiss.define('web_swiss.BackendThemeCustomizer', function (require) {
    "use strict";
    ...
    var BackendThemeCustomizer = Widget.extend({
        template: 'web_swiss.theme_customizer.menu',
        ...
        _render: function() {
            this.$('.f-theme-customizer-toggler').parent().append(QWeb.render('web_swiss.theme_customizer.panel', this));
            var panelContent = this.$('.f-theme-customizer-content')
            var adminPanel = QWeb.render('web_swiss.theme_customizer.panel.admin', this);
            var userPanel = QWeb.render('web_swiss.theme_customizer.panel.user', this);
            if (session.is_admin) {

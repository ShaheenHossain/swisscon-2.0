swiss.define('web_swiss.sidemenu', function (require) {
    "use strict";
...
swiss.define('web_swiss.sidemenu.AppsMenu', function (require) {
    "use strict";
    var AppsMenu = require('web.AppsMenu');
    var SideMenu = require('web_swiss.sidemenu');
    AppsMenu.include({
...
swiss.define('web_swiss.sidemenu.webclient', function (require) {
    "use strict";

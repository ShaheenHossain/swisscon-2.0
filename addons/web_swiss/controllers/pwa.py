from swiss.http import Controller, request, route, send_file, Response
from swiss.modules import get_resource_path
...
class ProgressiveWebApp(Controller):
    ...
    def _get_manifest(self, company_id):
        ...
        if config:
            ...
            if len(icons) == 0:
                icons = [{
                    "src": "/web_swiss/static/img/icons/icon-512x512.png",
                    "type": "image/png",
                    "sizes": "512x512",
                    }]
            ...
            file = get_resource_path('web_swiss', 'static', 'src', 'manifest.json')
    ...
    def service_worker(self):
        ...
        urls.extend([
            ...
            '/web_swiss/static/src/img/icons/icon-128x128.png',
            '/web_swiss/static/src/img/icons/icon-144x144.png',
            '/web_swiss/static/src/img/icons/icon-152x152.png',
            '/web_swiss/static/src/img/icons/icon-192x192.png',
            '/web_swiss/static/src/img/icons/icon-256x256.png',
            '/web_swiss/static/src/img/icons/icon-512x512.png',
        ])
        cache_version = "-".join(version_list)
        mimetype = "text/javascript;charset=utf-8"
        content = qweb._render(
            "web_swiss.service_worker",

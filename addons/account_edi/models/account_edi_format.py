...
from swiss.tools.pdf import SwissCRMPdfFileReader, SwissCRMPdfFileWriter
from swiss.osv import expression
from swiss.tools import html_escape
from swiss.exceptions import RedirectWarning
...
class AccountEdiFormat(models.Model):
    ...
    def _create_invoice_from_pdf_reader(self, filename, reader):
        ...
        :param reader:   The SwissCRMPdfFileReader of the pdf to import.
        :returns:        The created invoice.
        """
        # TO OVERRIDE
        self.ensure_one()
    ...
    def _prepare_invoice_report(self, pdf_writer, edi_document):
        ...
        if self._is_embedding_to_invoice_pdf_needed() and edi_document.attachment_id:
            pdf_writer.embed_swiss_attachment(edi_document.attachment_id)
    ...
    def _embed_edis_to_pdf(self, pdf_content, invoice):
        ...
        if to_embed:
            ...
            reader = SwissCRMPdfFileReader(reader_buffer, strict=False)
            writer = SwissCRMPdfFileWriter()
    ...
    def _decode_pdf(self, filename, content):
        ...
        * pdf_reader:       The pdf_reader if type is pdf.
        ...
        try:
            ...
            pdf_reader = SwissCRMPdfFileReader(buffer, strict=False)
        except Exception as e:
            # Malformed pdf

...
import swiss.addons.web.controllers.main
from swiss import http, _
from swiss.addons.auth_totp.models.res_users import TRUSTED_DEVICE_SCOPE
...
class Home(swiss.addons.web.controllers.main.Home):
    @http.route(
        '/web/login/totp',

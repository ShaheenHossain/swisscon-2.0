...
Also, adds methods to convert values back to SwissCRM models.
"""
...
import swiss.modules

from swiss import api, models, fields
from swiss.tools import ustr, posix_to_ldml, pycompat
from swiss.tools import html_escape as escape
from swiss.tools.misc import get_lang, babel_locale_parse
from swiss.addons.base.models import ir_qweb
...
class Image(models.AbstractModel):
    ...
    def load_local_url(self, url):
        ...
        path = swiss.modules.get_module_resource(

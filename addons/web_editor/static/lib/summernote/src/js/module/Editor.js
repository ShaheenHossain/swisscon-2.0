define([
  ...
  var Editor = function (handler) {
    ...
    this.style = style;   // SWISS: allow access for override
    this.table = table;   // SWISS: allow access for override
    this.typing = typing; // SWISS: allow access for override
    this.bullet = bullet; // SWISS: allow access for override
    ...
    this.saveRange = function ($editable, thenCollapse) {
      // SWISS: scroll to top when click on input in editable m (start_modification
      // this.focus($editable);
      var r = range.create();
      if (!r || ($editable[0] !== r.sc && !$.contains($editable[0], r.sc))) {
        $editable.focus();
      }
      // SWISS: end_modication)
    ...
    this.createLink = function ($editable, linkInfo, options) {
      ...
      var anchors = [];
      // SWISS: adding this branch to modify existing anchor if it fully contains the range
      ...
      $.each(anchors, function (idx, anchor) {
        ...
        $(anchor).attr('class', linkInfo.className || null); // SWISS: addition
        $(anchor).css(linkInfo.style || {}); // SWISS: addition
        if (isNewWindow) {

swiss.define('web_editor.rte.summernote', function (require) {
'use strict';
...
// outside the iframe.
const topBus = window.top.swiss.__DEBUG__.services['web.core'].bus;
...
// SwissCRM editor coming in future versions.
...
renderer.createPalette = function ($container, options) {
    ...
    const parent = swiss.__DEBUG__.services['root.widget'];

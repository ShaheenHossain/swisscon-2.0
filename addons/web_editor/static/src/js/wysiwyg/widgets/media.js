swiss.define('wysiwyg.widgets.media', function (require) {
'use strict';
...
/**
 * Let users choose a file, including uploading a new file in swiss.
 */
var FileWidget = SearchableMediaWidget.extend({
     ...
     * @returns {Array} "ir.attachment" swiss domain.
     */
...
/**
 * Let users choose an image, including uploading a new image in swiss.
 */
...
/**
 * Let users choose a document, including uploading a new document in swiss.
 */

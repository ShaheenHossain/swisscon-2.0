...
from swiss.addons.event.tests.common import TestEventCommon
from swiss.addons.mail.tests.common import mail_new_test_user
from swiss.fields import Datetime as FieldsDatetime, Date as FieldsDate
...
class EventDtPatcher(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.event_dt = patch(
            'swiss.addons.event.models.event_event.fields.Datetime',
            wraps=FieldsDatetime
        )
        cls.wevent_dt = patch(
            'swiss.addons.website_event.models.event_event.fields.Datetime',
            wraps=FieldsDatetime
        )
        cls.wevent_main_dt = patch(
            'swiss.addons.website_event.controllers.main.fields.Datetime',
            wraps=FieldsDatetime
        )
        cls.event_date = patch(
            'swiss.addons.event.models.event_event.fields.Date',
            wraps=FieldsDate
        )
        cls.wevent_main_date = patch(
            'swiss.addons.website_event.controllers.main.fields.Date',
            wraps=FieldsDate
        )

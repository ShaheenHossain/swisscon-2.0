...
import swiss
from swiss import api, fields, models, SUPERUSER_ID
...
class ImBus(models.Model):
    ...
    def sendmany(self, notifications):
        ...
        if channels:
            ...
            def notify():
                with swiss.sql_db.db_connect('postgres').cursor() as cr:
...
dispatch = None
if not swiss.multi_process or swiss.evented:

swiss.define('bus.Longpolling', function (require) {
"use strict";
...
var LongpollingBus = Bus.extend(ServicesMixin, {
    ...
    /**
     * Tell whether swiss is focused or not
     *
     * @returns {boolean}
     */
    isSwissCRMFocused: function () {
        return this._isSwissCRMFocused;
    },
    /**
    ...
    _onFocusChange: function (params) {
        this._isSwissCRMFocused = params.focus;
        if (params.focus) {
            this._lastPresenceTime = new Date().getTime();
            this.trigger('window_focus', this._isSwissCRMFocused);
        }
    },
    /**

...
from swiss.addons.auth_signup.models.res_users import SignupError
from swiss.addons.web.controllers.main import ensure_db, Home, SIGN_UP_REQUEST_PARAMS
from swiss.addons.base_setup.controllers.main import BaseSetup

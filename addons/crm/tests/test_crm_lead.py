...
from swiss.addons.crm.models.crm_lead import PARTNER_FIELDS_TO_SYNC, PARTNER_ADDRESS_FIELDS_TO_SYNC
from swiss.addons.crm.tests.common import TestCrmCommon, INCOMING_EMAIL
from swiss.addons.phone_validation.tools.phone_validation import phone_format
from swiss.exceptions import UserError
from swiss.tests.common import Form, users

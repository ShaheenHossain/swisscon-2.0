...
from swiss import api, fields, models, tools, SUPERUSER_ID
from swiss.osv import expression
from swiss.tools.translate import _
from swiss.tools import email_re, email_split
...
PLS_COMPUTE_BATCH_STEP = 50000  # swiss.models.PREFETCH_MAX = 1000 but larger cluster can speed up global computation

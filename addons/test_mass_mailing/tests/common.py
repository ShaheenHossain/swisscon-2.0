...
<span>Website0: <a id="url0" href="https://www.swiss.tz/my/${object.name}">https://www.swiss.tz/my/${object.name}</a></span>
<span>Website1: <a id="url1" href="https://www.swiss.be">https://www.swiss.be</a></span>
...
<span>Email: <a id="url7" href="mailto:test@swissconsultings.ch">test@swissconsultings.ch</a></span>

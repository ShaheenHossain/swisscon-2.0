...
from swiss import api, models, fields, _
from swiss.tests.common import Form
from swiss.exceptions import UserError
from swiss.addons.l10n_it_edi.tools.remove_signature import remove_signature
from swiss.osv.expression import OR, AND

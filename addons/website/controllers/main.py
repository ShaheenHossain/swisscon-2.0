...
from swiss import http, models, fields, _
from swiss.http import request
from swiss.tools import OrderedSet
from swiss.addons.http_routing.models.ir_http import slug, slugify, _guess_mimetype
from swiss.addons.web.controllers.main import Binary
from swiss.addons.portal.controllers.portal import pager as portal_pager
from swiss.addons.portal.controllers.web import Home
...
class Website(Home):
    ...
    def website_info(self, **kwargs):
        ...
        values = {
            'apps': apps,
            'l10n': l10n,
            'version': swiss.service.common.exp_version()
        }

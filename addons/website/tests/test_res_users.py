...
from swiss.tests.common import TransactionCase, new_test_user
from swiss.exceptions import ValidationError
from swiss.service.model import check
...
class TestWebsiteResUsers(TransactionCase):
    ...
    def test_same_website_message(self):
        ...
        with self.assertRaises(ValidationError), mute_logger('swiss.sql_db'):

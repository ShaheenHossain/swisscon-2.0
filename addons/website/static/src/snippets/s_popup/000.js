swiss.define('website.s_popup', function (require) {
'use strict';
...
$.fn.modal.Constructor.prototype._showElement = function () {
    ...
    if (this._element.classList.contains('s_popup_no_backdrop')) {
        ...
        // opened is a very specific SwissCRM behavior.
        ...
        this._swissLoadEventCaptureHandler = _.debounce(() => _updateScrollbar({ data: this }, 100));
        this._element.addEventListener('load', this._swissLoadEventCaptureHandler, true);
...
$.fn.modal.Constructor.prototype._hideModal = function () {
    ...
    if (this._swissLoadEventCaptureHandler) {
        this._element.removeEventListener('load', this._swissLoadEventCaptureHandler, true);
        delete this._swissLoadEventCaptureHandler;
    }
};

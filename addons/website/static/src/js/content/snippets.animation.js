swiss.define('website.content.snippets.animation', function (require) {
'use strict';
...
registry.mediaVideo = publicWidget.Widget.extend(MobileYoutubeAutoplayMixin, {
    ...
    start: function () {
        ...
        // integrated with SwissCRM (this refactoring should be done in master).
        ...
        // videos added before bug fixes or new SwissCRM versions where the

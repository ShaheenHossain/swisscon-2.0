swiss.define('website.content.menu', function (require) {
'use strict';
...
const BaseAnimatedHeader = animations.Animation.extend({
    ...
    start: function () {
        ...
        // transitionstart, so we listen to a custom swiss event.
        this._transitionCount = 0;
        this.$el.on('swiss-transitionstart.BaseAnimatedHeader', () => {
    ...
    _updateHeaderOnScroll: function (scroll) {
        ...
        if (this.headerIsScrolled !== headerIsScrolled) {
            ...
            this.$el.trigger('swiss-transitionstart');

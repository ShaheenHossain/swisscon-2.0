...
from swiss import registry, SUPERUSER_ID
from swiss.http import request
from swiss.tools.safe_eval import safe_eval
from swiss.osv.expression import FALSE_DOMAIN
from swiss.addons.http_routing.models.ir_http import ModelConverter, _guess_mimetype
...
class Http(models.AbstractModel):
    ...
    def _dispatch(cls):
        """
        In case of rerouting for translate (e.g. when visiting swissconsultings.ch/fr_BE/),

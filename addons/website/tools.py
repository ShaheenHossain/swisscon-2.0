...
import swiss
from swiss.tools.misc import DotDict
...
def MockRequest(
    ...
    with contextlib.ExitStack() as s:
        swiss.http._request_stack.push(request)
        s.callback(swiss.http._request_stack.pop)
        s.enter_context(patch('swiss.http.root.get_db_router', router))

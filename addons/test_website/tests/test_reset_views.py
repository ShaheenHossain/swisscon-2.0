...
class TestWebsiteResetViews(swiss.tests.HttpCase):
    ...
    @mute_logger('swiss.addons.http_routing.models.ir_http')
    ...
    # @mute_logger('swiss.addons.http_routing.models.ir_http', 'swiss.addons.website.models.ir_ui_view')

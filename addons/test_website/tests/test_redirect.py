...
from swiss.tests.common import HOST
...
class TestRedirect(HttpCase):
    ...
    def setUp(self):
        ...
        self.base_url = "http://%s:%s" % (HOST, swiss.tools.config['http_port'])
    ...
    @mute_logger('swiss.addons.http_routing.models.ir_http')  # mute 403 warning
    def test_02_redirect_308_RequestUID(self):
        ...
        WebsiteHttp = swiss.addons.website.models.ir_http.Http

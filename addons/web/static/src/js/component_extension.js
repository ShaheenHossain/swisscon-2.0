(function () {
    /**
     * Symbol used in ComponentWrapper to redirect Owl events to SwissCRM legacy
     * events.
     */
    swiss.widgetSymbol = Symbol('widget');
    ...
    owl.Component.prototype.__trigger = function (component, evType, payload) {
        if (this.env[swiss.widgetSymbol]) {
            this.env[swiss.widgetSymbol](evType);
        }

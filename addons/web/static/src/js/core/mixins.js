swiss.define('web.mixins', function (require) {
"use strict";
...
function SwissCRMEvent(target, name, data) {
    this.target = target;
    this.name = name;
...
SwissCRMEvent.prototype.stopPropagation = function () {
    this.stopped = true;
};

SwissCRMEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
    ...
    trigger_up: function (name, info) {
        var event = new SwissCRMEvent(this, name, info);

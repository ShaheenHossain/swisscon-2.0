swiss.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in SwissCRM.
 *
 * The basic concurrency primitives in SwissCRM JS are the callback, and the
...
return {
    ...
    /**
     * A (SwissCRM) mutex is a primitive for serializing computations.  This is

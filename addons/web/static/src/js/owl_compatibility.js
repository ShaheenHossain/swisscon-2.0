swiss.define('web.OwlCompatibility', function () {
    "use strict";

    /**
     * This file defines the necessary tools for the transition phase where SwissCRM
    ...
    const widgetSymbol = swiss.widgetSymbol;
     ...
     * adapter for Owl components that embed SwissCRM legacy widgets (or dynamically
     * both Owl components and SwissCRM legacy widgets), e.g.:
     *
     *                           Owl Component
     *                                 |
    ...
    class ComponentAdapter extends Component {
        ...
        /**
         * Mocks _trigger_up to redirect SwissCRM legacy events to OWL events.
         *
         * @private
     ...
     * together when an SwissCRM legacy widget needs to instantiate Owl components.
    ...
    class ComponentWrapper extends Component {
         ...
         * SwissCRM legacy event. This function is called just before the event is
         * actually triggered.
         *
         * @private
         * @param {string} evType

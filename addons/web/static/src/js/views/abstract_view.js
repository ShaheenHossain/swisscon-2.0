swiss.define('web.AbstractView', function (require) {
"use strict";

/**
 * This is the base class inherited by all (JS) views. SwissCRM JS views are the
 ...
 * the word 'view' has historical significance in SwissCRM code, so we replaced the

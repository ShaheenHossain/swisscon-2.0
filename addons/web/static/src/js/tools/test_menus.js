(function (exports) {
    ...
    let isEnterprise = swiss.session_info.server_version_info[5] === 'e';

    function createWebClientHooks() {
        var AbstractController = swiss.__DEBUG__.services['web.AbstractController'];
        var DiscussWidget = swiss.__DEBUG__.services['mail/static/src/widgets/discuss/discuss.js'];
        var WebClient = swiss.__DEBUG__.services["web.WebClient"];

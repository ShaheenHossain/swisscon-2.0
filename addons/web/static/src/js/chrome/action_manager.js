swiss.define('web.ActionManager', function (require) {
"use strict";
 ...
 * Its role is to makes sure that SwissCRM actions are properly started and
 * coordinated.
 */
...
var ActionManager = Widget.extend({
    ...
    /**
     * This is the entry point to execute SwissCRM actions, given as an ID in

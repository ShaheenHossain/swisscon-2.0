swiss.define('web.owl_dialog_tests', function (require) {
    "use strict";
    ...
    QUnit.module('core', {}, function () {
        ...
        QUnit.test("Rendering of all props", async function (assert) {
            ...
            assert.containsNone(document.body, '.modal-backdrop'); // No backdrop *element* for SwissCRM modal...
            ...
            // Title (default: 'SwissCRM')
            assert.strictEqual(dialog.querySelector('h4.modal-title').innerText.trim(), "SwissCRM" + "The Subtitle",

 ...
 * QUnit Config
 *
 * The SwissCRM javascript test framework is based on QUnit (http://qunitjs.com/).
 * This file is necessary to setup Qunit and to prepare its interactions with
 * SwissCRM.  It has to be loaded before any tests are defined.
 *
 * Note that it is not an SwissCRM module, because we want this code to be executed
 * as soon as possible, not whenever the SwissCRM module system feels like it.
 */
 ...
 * this is done outside of swiss modules, otherwise the setting would not take
 * effect on time.
 */
...
async function checkModules() {
    ...
    await swiss.__DEBUG__.didLogInfo;

    const info = swiss.__DEBUG__.jsModules;
 ...
 */
QUnit.on('SwissCRMAfterTestHook', function (info) {

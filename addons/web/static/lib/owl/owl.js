...
See https://github.com/swiss/owl/blob/master/doc/reference/config.md#mode for more information.`);
            }
        },
    });
    ...
    class Component {
         ...
         *  - it can be patched (useful in swiss ecosystem)
  ...
  `;
    ...
    __info__.url = 'https://github.com/swiss/owl';

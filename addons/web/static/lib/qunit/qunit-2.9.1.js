...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("SwissCRMBeforeTestHook", "SwissCRMAfterTestHook"); // SwissCRM customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("SwissCRMBeforeTestHook"); // SwissCRM customization
  	...
  	finish: function finish() {
        ...
        emit("SwissCRMAfterTestHook", this); // SwissCRM customization

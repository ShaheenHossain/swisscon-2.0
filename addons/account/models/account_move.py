...
from swiss.exceptions import RedirectWarning, UserError, ValidationError, AccessError
from swiss.tools import float_compare, date_utils, email_split, email_re, float_is_zero
from swiss.tools.misc import formatLang, format_date, get_lang
...
class AccountMove(models.Model):
    ...
    def _get_invoice_reference_swiss_invoice(self):
        """ This computes the reference based on the SwissCRM format.
    ...
    def _get_invoice_reference_swiss_partner(self):
        """ This computes the reference based on the SwissCRM format.

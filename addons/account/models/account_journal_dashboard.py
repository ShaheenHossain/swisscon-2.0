...
from swiss import models, api, _, fields
from swiss.osv import expression
from swiss.release import version
from swiss.tools import DEFAULT_SERVER_DATE_FORMAT as DF
from swiss.tools.misc import formatLang, format_date as swiss_format_date, get_lang
import random
        ...
        for journal in self:
            ...
            for activity in self.env.cr.dictfetchall():
                act = {
                    ...
                    'date': swiss_format_date(self.env, activity.get('date_deadline'))
                }

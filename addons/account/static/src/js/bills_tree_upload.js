swiss.define('account.upload.bill.mixin', function (require) {
"use strict";
...
swiss.define('account.bills.tree', function (require) {
"use strict";
    var core = require('web.core');
...
swiss.define('account.dashboard.kanban', function (require) {
"use strict";
    var core = require('web.core');

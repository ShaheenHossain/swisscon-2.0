...
from swiss.api import Environment
from swiss.tools import DEFAULT_SERVER_DATE_FORMAT
from datetime import date, timedelta

from swiss.tests import Form, tagged, new_test_user
from swiss.addons.point_of_sale.tests.test_frontend import TestPointOfSaleHttpCommon

...
from swiss.addons.website_slides.tests import common
...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('swiss.models', 'swiss.addons.base.models.ir_rule')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('swiss.models.unlink', 'swiss.addons.base.models.ir_rule', 'swiss.addons.base.models.ir_model')

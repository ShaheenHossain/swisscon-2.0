...
from swiss.service.server import memory_info
    ...
    def _handle_exception(self, exception):
        ...
        try:
            ...
            if not isinstance(
                exception,
                (
                    swiss.exceptions.Warning,
                    SessionExpiredException,
                    swiss.exceptions.except_orm,
            ...
            if isinstance(exception, AuthenticationError):
                error["code"] = 100
                error["message"] = "SwissCRM Session Invalid"
            if isinstance(exception, SessionExpiredException):
                error["code"] = 100
                error["message"] = "SwissCRM Session Expired"

...
from swiss import _, api, exceptions, fields, models

from swiss.addons.base_api.lib.pinguin import transform_strfields_to_dict
...
def getmembers(obj, predicate=None):
    ...
    for key in names:
        if key == "_cache":
            # NEW
            # trying to read this key will return error in swiss 11.0+

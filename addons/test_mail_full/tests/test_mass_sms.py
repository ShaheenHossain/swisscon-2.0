...
from swiss.addons.phone_validation.tools import phone_validation
...
class TestMassSMSInternals(TestMassSMSCommon):
    ...
    @mute_logger('swiss.addons.mail.models.mail_render_mixin')
...
class TestMassSMS(TestMassSMSCommon):
    ...
    def test_mass_sms_links(self):
        ...
        mailing.write({
            'body_plaintext': 'Dear ${object.display_name} this is a mass SMS with two links http://www.swissconsultings.ch/smstest and http://www.swissconsultings.ch/smstest/${object.name}',
        ...
        self.assertSMSTraces(
            ...
            mailing, self.records,
            sms_links_info=[[
                ('http://www.swissconsultings.ch/smstest', True, {}),
                ('http://www.swissconsultings.ch/smstest/%s' % record.name, True, {}),
    ...
    def test_mass_sms_partner_only(self):
        ...
        self.assertSMSTraces(
            ...
            sms_links_info=[[
                ('http://www.swissconsultings.ch/smstest', True, {}),
                ('http://www.swissconsultings.ch/smstest/%s' % record.id, True, {}),
                # unsubscribe is not shortened and parsed at sending
                ('unsubscribe', False, {}),
            ] for record in records],
        )
        ...
        self.assertSMSTraces(
            ...
            sms_links_info=[[
                ('http://www.swissconsultings.ch/smstest', True, {}),
                ('http://www.swissconsultings.ch/smstest/%s' % new_record.id, True, {}),
                # unsubscribe is not shortened and parsed at sending
                ('unsubscribe', False, {}),
            ]],
        )

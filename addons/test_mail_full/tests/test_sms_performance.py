...
from swiss.addons.sms.tests import common as sms_common
from swiss.addons.test_mail.tests.test_performance import BaseMailPerformance
...
class TestSMSPerformance(BaseMailPerformance, sms_common.SMSCase):
    ...
    @mute_logger('swiss.addons.sms.models.sms_sms')
    @users('employee')
    @warmup

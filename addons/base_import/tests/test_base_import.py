...
from swiss.tests.common import TransactionCase, can_import
from swiss.modules.module import get_module_resource
from swiss.tools import mute_logger, pycompat
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('swiss.addons.base_import.models.base_import')

...
from swiss import api, http, SUPERUSER_ID, _
from swiss.exceptions import AccessDenied
from swiss.http import request
from swiss import registry as registry_get

from swiss.addons.auth_signup.controllers.main import AuthSignupHome as Home
from swiss.addons.web.controllers.main import db_monodb, ensure_db, set_cookie_and_redirect, login_and_redirect
...
class OAuthController(http.Controller):
    ...
    def oea(self, **kw):
        """login user via SwissCRM Account provider"""

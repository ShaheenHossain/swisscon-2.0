...
from swiss import exceptions
from swiss.addons.mail.tests.common import mail_new_test_user
from swiss.addons.test_mail.data import test_mail_data
from swiss.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE
from swiss.addons.test_mail.models.test_mail_models import MailTestGateway
from swiss.addons.test_mail.tests.common import TestMailCommon
from swiss.tests import tagged
from swiss.tests.common import users
from swiss.tools import email_split_and_format, formataddr, mute_logger
...
class TestMailgateway(TestMailCommon):
    ...
    @mute_logger('swiss.addons.mail.models.mail_thread', 'swiss.models')
    ...
    @mute_logger('swiss.addons.mail.models.mail_thread')
    ...
    def test_message_process_followers(self):
        """ Incoming email: recognized author not archived and not swissbot: added as follower """
        ...
        swissbot = self.env.ref('base.partner_root')
        swissbot.active = True
        swissbot.email = 'swissbot@example.com'
        with self.mock_mail_gateway():
            record4 = self.format_and_process(
                MAIL_TEMPLATE, swissbot.email_formatted, 'groups@test.com',
                subject='SwissCRMbot Automatic Answer')

        self.assertEqual(record4.message_ids[0].author_id, swissbot)
        self.assertEqual(record4.message_ids[0].email_from, swissbot.email_formatted)
    ...
    @mute_logger('swiss.addons.mail.models.mail_thread', 'swiss.models.unlink', 'swiss.addons.mail.models.mail_mail')
    ...
    @mute_logger('swiss.addons.mail.models.mail_thread', 'swiss.addons.mail.models.mail_mail', 'swiss.models.unlink')
    ...
    def test_message_process_references_external(self):
        """ Incoming email being a reply to an external email processed by swiss should update thread accordingly """
    ...
    def test_message_process_references_external_buggy_message_id(self):
        ...
        swiss should update thread accordingly. Special case when the
    ...
    def test_message_process_extra_model_res_id(self):
        ...
        # SwissCRM 10 update: compat mode has been removed and should not work anymore

...
from swiss.tests import tagged, Form
...
from swiss.exceptions import AccessError, ValidationError, UserError
...
class TestChannelAccessRights(TestMailCommon):
    ...
    @mute_logger('swiss.addons.base.models.ir_model', 'swiss.models')
    ...
    @mute_logger('swiss.addons.base.models.ir_model', 'swiss.models', 'swiss.models.unlink')
...
class TestChannelFeatures(TestMailCommon):
    ...
    @mute_logger('swiss.addons.mail.models.mail_mail', 'swiss.models.unlink')
    ...
    @mute_logger('swiss.models.unlink')
...
class TestChannelModeration(TestMailCommon):
    ...
    @mute_logger('swiss.addons.mail.models.mail_channel', 'swiss.models.unlink')

...
from swiss.tests.common import users, warmup
...
class TestMailAPIPerformance(BaseMailPerformance):
    ...
    @users('__system__', 'emp')
    @warmup
    @mute_logger('swiss.models.unlink', 'swiss.tests', 'swiss.addons.mail.models.mail_mail')
    ...
    @users('__system__', 'emp')
    @warmup
    @mute_logger('swiss.tests', 'swiss.addons.mail.models.mail_mail')
    ...
    @users('__system__', 'emp')
    @warmup
    @mute_logger('swiss.tests', 'swiss.addons.mail.models.mail_mail', 'swiss.models.unlink')

...
from swiss.addons.stock_account.tests.test_anglo_saxon_valuation_reconciliation_common import ValuationReconciliationTestCommon
from swiss.tests import common, Form
from swiss.exceptions import UserError
from swiss.tools import mute_logger, float_compare
from swiss.addons.stock_account.tests.test_stockvaluation import _create_accounting_data
...
class TestSaleMrpFlow(ValuationReconciliationTestCommon):
    ...
    @mute_logger('swiss.tests.common.onchange')

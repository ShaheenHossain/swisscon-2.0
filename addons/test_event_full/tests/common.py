...
from swiss.addons.event_crm.tests.common import TestEventCrmCommon
from swiss.addons.sales_team.tests.common import TestSalesCommon
from swiss.addons.website.tests.test_website_visitor import MockVisitor
from swiss.addons.website_event.tests.common import EventDtPatcher

...
from swiss import SUPERUSER_ID, _, api, fields, models
from swiss.addons.stock.models.stock_move import PROCUREMENT_PRIORITIES
from swiss.exceptions import UserError
from swiss.osv import expression
from swiss.tools import DEFAULT_SERVER_DATETIME_FORMAT, format_datetime
from swiss.tools.float_utils import float_compare, float_is_zero, float_round
from swiss.tools.misc import format_date
...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        ...
        help="If this checkbox is ticked, SwissCRM will automatically pre-fill the detailed "

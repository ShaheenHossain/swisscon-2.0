...
from swiss import SUPERUSER_ID, _, api, fields, models, registry
from swiss.exceptions import UserError
from swiss.osv import expression
from swiss.tools import float_compare, float_is_zero, html_escape
from swiss.tools.misc import split_every
...
class StockRule(models.Model):
    ...
    def _get_lead_days(self, product):
        ...
        :type product: :class:`~swiss.addons.product.models.product.ProductProduct`
...
class ProcurementGroup(models.Model):
    ...
    def run(self, procurements, raise_user_error=True):
        ...
        :type list: list of `~swiss.addons.stock.models.stock_rule.ProcurementGroup.Procurement`

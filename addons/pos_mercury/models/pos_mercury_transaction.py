...
from swiss import models, api, service
from swiss.tools.translate import _
from swiss.exceptions import UserError
from swiss.tools import DEFAULT_SERVER_DATETIME_FORMAT, misc
...
class MercuryTransaction(models.Model):
    ...
    def _setup_request(self, data):
        ...
        data['memo'] = "SwissCRM " + service.common.exp_version()['server_version']

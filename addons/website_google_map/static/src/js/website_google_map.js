function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('swiss-google-map'), {
        zoom: 1,
    ...
    if (swiss_partner_data){ /* swiss_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < swiss_partner_data.counter; i++) {
            set_marker(swiss_partner_data.partners[i]);
        }

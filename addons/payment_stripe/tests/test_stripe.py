...
@swiss.tests.tagged('post_install', '-at_install', '-standard', 'external')
class StripeTest(StripeCommon):

    def run(self, result=None):
        with mute_logger('swiss.addons.payment.models.payment_acquirer', 'swiss.addons.payment_stripe.models.payment'):
    ...
    @patch('swiss.addons.payment_stripe.models.payment.request')
    @patch('swiss.addons.payment_stripe.models.payment.datetime')
    ...
    def test_handle_checkout_webhook_no_swiss_tx(self):
        stripe_object = stripe_mocks.checkout_session_object

...
class AccountBankStatementImport(models.TransientModel):
    ...
    def import_file(self):
        ...
        for data_file in self.attachment_ids:
            currency_code, account_number, stmts_vals = self.with_context(active_id=self.ids[0])._parse_file(
                base64.b64decode(data_file.datas))
            # Check raw data
            self._check_parsed_data(stmts_vals, account_number)
            # Try to find the currency and journal in swiss
                ...
                - bank statements data: list of dict containing (optional items marked by o) :
                    ...
                    - 'transactions': list of dict containing :
                        ...
                        -o 'account_number': string
                            Will be used to find/create the res.partner.bank in swiss
                        -o 'note': string

swiss.define('website_sale_tour.tour', function (require) {
    'use strict';
    ...
    },
    {
        ...
        run: function () {
            ...
            $('input[name="email"]').val('abc@swissconsultings.ch');
    ...
    },
    {
        ...
        trigger: '.oe_login_form',
        run: function () {
            $('.oe_login_form input[name="login"]').val("abc@swissconsultings.ch");

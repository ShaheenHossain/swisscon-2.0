...
from swiss.addons.base.tests.common import HttpCaseWithUserDemo, TransactionCaseWithUserDemo
from swiss.addons.website_sale.controllers.main import WebsiteSale
from swiss.addons.website_sale.tests.common import TestWebsiteSaleCommon

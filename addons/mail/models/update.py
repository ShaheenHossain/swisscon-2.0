...
from swiss import api, release, SUPERUSER_ID
from swiss.exceptions import UserError
from swiss.models import AbstractModel
from swiss.tools.translate import _
from swiss.tools import config, misc, ustr
...
class PublisherWarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to SwissCRM's publisher warranty server to check the

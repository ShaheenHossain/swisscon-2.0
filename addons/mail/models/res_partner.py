...
from swiss import _, api, fields, models, tools
from swiss.addons.bus.models.bus_presence import AWAY_TIMER
from swiss.addons.bus.models.bus_presence import DISCONNECTION_TIMER
...
class Partner(models.Model):
    ...
    def _compute_im_status(self):
        ...
        swissbot = self.env['res.partner'].browse(swissbot_id)
        if swissbot in self:
            swissbot.im_status = 'bot'

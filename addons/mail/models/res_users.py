...
from swiss import _, api, exceptions, fields, models, modules
from swiss.addons.base.models.res_users import is_selection_groups
...
class Users(models.Model):
    ...
    notification_type = fields.Selection([
        ...
        ('inbox', 'Handle in SwissCRM')],
        'Notification', required=True, default='email',
        help="Policy on how to handle Chatter notifications:\n"
             "- Handle by Emails: notifications are sent to your email address\n"
             "- Handle in SwissCRM: notifications appear in your SwissCRM Inbox")

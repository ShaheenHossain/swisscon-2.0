swiss.define('mail/static/src/components/composer_suggestion/composer_suggestion_partner_tests.js', function (require) {
'use strict';
...
QUnit.test('partner mention suggestion correct data', async function (assert) {
    ...
    const partner = this.env.models['mail.partner'].create({
        email: "demo_user@swissconsultings.ch",
        id: 7,
        im_status: 'online',
        name: "Demo User",
    });

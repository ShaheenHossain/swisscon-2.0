swiss.define('mail/static/src/components/messaging_menu/messaging_menu_tests.js', function (require) {
'use strict';
...
QUnit.test('rendering with SwissCRMBot has a request (default)', async function (assert) {
    assert.expect(4);
    ...
    assert.ok(
        ...
        "should display a notification counter next to the messaging menu for SwissCRMBot request"
    );
    assert.strictEqual(
        document.querySelector('.o_MessagingMenu_counter').textContent,
        "1",
    ...
    assert.strictEqual(
        ...
        'SwissCRMBot has a request',
        "notification should display that SwissCRMBot has a request"
    );
});

QUnit.test('rendering without SwissCRMBot has a request (denied)', async function (assert) {
    assert.expect(2);
...
QUnit.test('rendering without SwissCRMBot has a request (accepted)', async function (assert) {
    assert.expect(2);

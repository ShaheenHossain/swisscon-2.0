swiss.define('mail.ActivityRenderer', function (require) {
"use strict";
...
/**
 * Owl Component Adapter for ActivityRecord which is KanbanRecord (SwissCRM Widget)
...
/**
 * Owl Component Adapter for KanbanColumnProgressBar (SwissCRM Widget)

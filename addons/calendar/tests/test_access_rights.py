...
from swiss.tests.common import SavepointCase, new_test_user
...
class TestAccessRights(SavepointCase):
    ...
    @classmethod
    @mute_logger('swiss.tests', 'swiss.addons.auth_signup.models.res_users')
    def setUpClass(cls):
        super().setUpClass()
    ...
    @mute_logger('swiss.addons.base.models.ir_rule')

...
class SwissCRMBaseChecker(checkers.BaseChecker):
    ...
    msgs = {
        'E8502': (
            ...
            'gettext-variable',
            'See https://doc.swisshq.com/2.0/reference/translations.html#variables'
        )
    }
...
def register(linter):
    linter.register_checker(SwissCRMBaseChecker(linter))

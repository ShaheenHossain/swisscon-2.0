...
import swiss.exceptions
from swiss import models, api
...
class m(models.Model):
    ...
    def generate_redirect_warning(self):
        ...
        raise swiss.exceptions.RedirectWarning('description', action.id, 'Go to the redirection')

    def generate_access_denied(self):
        raise swiss.exceptions.AccessDenied()

    def generate_access_error(self):
        raise swiss.exceptions.AccessError('description')
    ...
    def generate_user_error(self):
        raise swiss.exceptions.UserError('description')

    def generate_missing_error(self):
        raise swiss.exceptions.MissingError('description')

    def generate_validation_error(self):
        raise swiss.exceptions.ValidationError('description')

...
from swiss.exceptions import AccessDenied, UserError
from swiss.osv import expression
from swiss.tools.parse_version import parse_version
from swiss.tools.misc import topological_sort
...
class Module(models.Model):
    ...
    license = fields.Selection([
        ...
        ('OPL-1', 'SwissCRM Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('SwissCRM Enterprise Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("SwissCRM is currently processing a scheduled action.\n"
    ...
    def install_from_urls(self, urls):
        ...
        OPENERP = swiss.release.product_name.lower()
        ...
        try:
            ...
            if urls.get(OPENERP):
                ...
                # copy all modules in the SERVER/swiss/addons directory to the new "swiss" module (except base itself)
                for d in os.listdir(base_path):
                    if d != 'base' and os.path.isdir(os.path.join(base_path, d)):
                        destdir = os.path.join(tmp, OPENERP, 'addons', d)    # XXX 'swiss' subdirectory ?
                ...
                _logger.info('Copy downloaded module `swiss` to `%s`', server_dir)

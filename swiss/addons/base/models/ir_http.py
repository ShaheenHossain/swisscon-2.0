...
import swiss
from swiss import api, http, models, tools, SUPERUSER_ID
from swiss.exceptions import AccessDenied, AccessError, MissingError
from swiss.http import request, content_disposition
from swiss.tools import consteq, pycompat
from swiss.tools.mimetypes import guess_mimetype
from swiss.modules.module import get_resource_path, get_module_path

from swiss.http import ALLOWED_DEBUG_MODES
from swiss.tools.misc import str2bool
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls, key=None):
        ...
        if key not in cls._routing_map:
            ...
            installed = request.registry._init_modules | set(swiss.conf.server_wide_modules)
            if tools.config['test_enable'] and swiss.modules.module.current_test:
                installed.add(swiss.modules.module.current_test)

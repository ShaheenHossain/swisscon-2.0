...
from swiss import api, models, tools
from swiss.tools.safe_eval import assert_valid_codeobj, _BUILTINS, _SAFE_OPCODES
from swiss.tools.misc import get_lang
from swiss.http import request
from swiss.modules.module import get_resource_path

from swiss.addons.base.models.qweb import QWeb, Contextifier
from swiss.addons.base.models.assetsbundle import AssetsBundle
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _get_asset_content(self, xmlid, options):
        ...
        def get_modules_order():
            if request:
                from swiss.addons.web.controllers.main import module_boot

...
from swiss.exceptions import AccessError, ValidationError
...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - swiss/addons/test_access_rights/tests/test_feedback.py
        # - swiss/addons/test_access_rights/tests/test_ir_rules.py
        # - swiss/addons/base/tests/test_orm.py (/home/dle/src/swiss/master-nochange-fp/swiss/addons/base/tests/test_orm.py)
        self.flush()
        self.clear_caches()
        return res

...
from swiss.http import Controller, dispatch_rpc, request, route
from swiss.service import wsgi_server
from swiss.fields import Date, Datetime
from swiss.tools import lazy, ustr
from swiss.tools.misc import frozendict

# ustr decodes as utf-8 or latin1 so we can search for the ASCII bytes
# 	Char	   ::=   	#x9 | #xA | #xD | [#x20-#xD7FF]
XML_INVALID = re.compile(b'[\x00-\x08\x0B\x0C\x0F-\x1F]')
class SwissCRMMarshaller(xmlrpc.client.Marshaller):
    ...
    # Historically, swiss is sending binary as base64 string.
...
xmlrpc.client.Marshaller = SwissCRMMarshaller

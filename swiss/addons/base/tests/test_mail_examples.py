...
cite="mid:CAEJSRZvWvud8c6Qp=wfNG6O1+wK3i_jb33qVrF7XyrgPNjnyUA@mail.gmail.com"
      type="cite"><base href="https://www.swissconsultings.ch">
      <div dir="ltr">Yep Dominique that is true, as Postgres was the
        base of all same as SwissCRM and MySQL etc came much later.Â 
        <div><br>
        </div>
    ...
    on this SwissCRM mailinglist, but when you start implying that Postgres
...
<a href="http://localhost:7073#action=login&amp;db=mail_1&amp;token=rHdWcUART5PhEnJRaXjH">http://localhost:7073#action=login&amp;db=mail_1&amp;token=rHdWcUART5PhEnJRaXjH</a></p>
      </div>
    </blockquote>
...
<div><p>Log in our portal at: <a href="http://localhost:7073#action=login&amp;db=mail_1&amp;login=demo">http://localhost:7073#action=login&amp;db=mail_1&amp;login=demo</a></p></div>
...
HOTMAIL_1 = u"""<div>
    <div dir="ltr"><br>
        ...
        <div>
            ...
            Best regards,<br>
            <pre>
                <a href="http://swissconsultings.ch" target="_blank">http://swissconsultings.ch</a>
...
HOTMAIL_1_OUT = [
    ...
    u"""<pre data-o-mail-quote="1">
                <a href="http://swissconsultings.ch" target="_blank" data-o-mail-quote="1">http://swissconsultings.ch</a>
                Belgium: +32.81.81.37.00
                U.S.: +1 (650) 307-6736
                India: +91 (79) 40 500 100
            </pre>"""]
...
<div class="WordSection1">
            ...
            <div style="border:none;border-top:solid #B5C4DF 1.0pt;padding:3.0pt 0in 0in 0in">
                <p class="MsoNormal">
                    ...
                    <span style="font-size:10.0pt;font-family:&quot;Tahoma&quot;,&quot;sans-serif&quot;">
                        OpenERP Enterprise [mailto:sales@swissconsultings.ch]
        ...
        <pre>--<p></p></pre>
        <pre>Nicolas<p></p></pre>
        <pre><a href="http://swissconsultings.ch">http://swissconsultings.ch</a><p></p></pre>
...
B-1367 Gérompont
Tel: +32.81.81.37.00
Web: http://www.swissconsultings.ch</pre>"""
...
<div style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'; COLOR: #000000">
    <div>Hello</div>
    <div>I have just installed SwissCRM 9 and I've got the following error:</div>
    <div>&nbsp;</div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content openerp">
                <div class="modal-header"> 
                    <h4 class="modal-title">SwissCRM Error<span class="o_subtitle text-muted"></span></h4>
                </div>

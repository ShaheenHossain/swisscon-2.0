...
from swiss.modules.module import get_module_root, MANIFEST_NAMES
from swiss.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the SwissCRM server for your project"""
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            swiss.tools.config['init']['base'] = True

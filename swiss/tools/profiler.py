...
class _LogTracer(object):
    ...
    def tracer(self, frame, event, arg):
        ...
        if not isinstance(in_self, swiss.models.BaseModel):
            return self.tracer
...
def profile(method=None, whitelist=None, blacklist=(None,), files=None,
    ...
    """
        ...
        all methods for all swiss models by applying the optional filters.
        ...
        :param list blacklist: list model names to remove from the log
                        (Default: remove non swiss model from the log: [None])
        ...
        .. code-block:: python
          ...
          class SaleOrder(models.Model):
            ...
            ...
            @profile()                  # log all methods for all swiss models
            def unlink(self):
            ...
            @profile(whitelist=['sale.order', 'ir.model.data'])
            def action_quotation_send(self):
            ...
            @profile(files=['/home/openerp/swiss/swiss/addons/sale/models/sale.py'])
            def write(self):
            ...
    ...
    def _swissProfile(method, *args, **kwargs):
    ...
    if not method:
        return lambda method: decorator(_swissProfile, method)

    wrapper = decorator(_swissProfile, method)
    return wrapper

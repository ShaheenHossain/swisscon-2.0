...
class SwissCRMPdfFileReader(PdfFileReader):
...
class SwissCRMPdfFileWriter(PdfFileWriter):
    ...
    def embed_swiss_attachment(self, attachment, subtype=None):
        assert attachment, "embed_swiss_attachment cannot be called without attachment."

...
from .. import tools
from .common import TagsSelector, SwissCRMSuite
from .runner import SwissCRMTestResult
...
def get_test_modules(module):
    ...
    results = _get_tests_modules('swiss.addons', module)

    try:
        importlib.import_module('swiss.upgrade.%s' % module)
    except ImportError:
        pass
    else:
        results += _get_tests_modules('swiss.upgrade', module)
